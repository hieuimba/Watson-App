...
##-------------------------------------------------SETTINGS-----------------------------------------------------------##
##----------LAYOUT SETUP----------
icon = Image.open(r'C:\Users\hieui\Desktop\Python\trade\venv_01\STREAMLIT\favicon.ico')
st.set_page_config(layout='wide', page_title='Watson 3', page_icon='🔧')
st.markdown("<style>#MainMenu {visibility: hidden; } footer {visibility: hidden;}</style>", unsafe_allow_html=True)
st.markdown("<style>header {visibility: hidden;}</style>", unsafe_allow_html=True)

risk = 20  # <--------using static risk
...
with two:
    option = st.radio('', options=['Positions', 'Position Calc', 'Orders', 'Sectors', 'Watchlist', 'Scanner'])
...
if option == 'Positions':
    ...
    with two:
        ...
        tradingview = open(r'C:\Users\hieui\Desktop\Python\trade\venv_01\STREAMLIT\tradingview.html', 'r', encoding='utf-8')
...
if option == 'Position Calc':
    ...
    with two:
        ...
        st.text(
            f"Symbol: {symbol[i]},    Name: {bars.iloc[-1]['Name']},    Sector: {bars.iloc[-1]['Sector']}")
        st.text(
...
if option == 'Watchlist':
    ...
    with one:
        ...
        st.caption('Clear input when done, - is space')
    ...
    with two:
        ...
        if len(selections) >0:
            ...
            tradingview = open(r'C:\Users\hieui\Desktop\Python\trade\venv_01\STREAMLIT\tradingview_watchlist.html', 'r', encoding='utf-8')
            source_code = tradingview.read()
